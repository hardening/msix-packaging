...
option(USE_SYSTEM_XERCES "Link against the system-installed Xerces-C++ library (found via pkg-config) instead of building the vendored copy under lib/xerces. Only meaningful when XML_PARSER is xerces." OFF)
option(USE_SYSTEM_ZLIB "Link against the system-installed zlib library instead of building the vendored copy under lib/zlib." OFF)
option(USE_SYSTEM_OPENSSL "Link against the system-installed OpenSSL library instead of building the vendored copy under lib/openssl. Only meaningful when CRYPTO_LIB is openssl." OFF)
